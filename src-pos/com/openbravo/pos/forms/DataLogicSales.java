...
public class DataLogicSales extends BeanFactoryDataSingle {
    ...
    public final ProductInfoExtCat getProductInfoandCatByCode(String sCode) throws BasicException {
        return (ProductInfoExtCat) new PreparedSentence(s
                , "SELECT P.ID, P.REFERENCE, P.CODE, P.NAME, P.ISCOM, P.ISSCALE, P.PRICEBUY, P.PRICESELL, P.TAXCAT, P.CATEGORY, P.ATTRIBUTESET_ID, P.IMAGE, P.ATTRIBUTES, C.NAME  " +
                "FROM PRODUCTS P INNER JOIN CATEGORIES C ON P.CATEGORY = C.ID WHERE CODE = ?"
                , SerializerWriteString.INSTANCE
                , ProductInfoExtCat.getSerializerRead()).find(sCode);
    }
    ...
    public final int getLastestCode() throws BasicException {
        PreparedSentence p =  new PreparedSentence(s, "SELECT MAX(CODE) FROM PRODUCTS ", null
                , SerializerReadInteger.INSTANCE);
        Integer d = (Integer) p.find();
        return d == null ? 10000000 : d;
    }
